...
public class MasterCharacter
{
    ...
    public static void Set(MasterCharacterModel[] master_character_model_list)
    {
        ...
        {
            string query = string.Format("insert or replace into master_character(character_id, asset_id, character_name, rarity, type, sell_point) values(\'{0}\', \'{1}\', \'{2}\', \'{3}\', \'{4}\', \'{5}\');", masterCharacterModel.character_id, masterCharacterModel.asset_id, masterCharacterModel.character_name, masterCharacterModel.rarity, masterCharacterModel.type, masterCharacterModel.sell_point);
