...
public static class MasterLoginItem
{
    ...
    public static void Set(MasterLoginItemModel[] master_login_item_model_list)
    {
        ...
        {
            string query = string.Format("insert or replace into master_login_item(login_day, item_type, item_count) values(\'{0}\', \'{1}\', \'{2}\');", masterLoginItemModel.login_day, masterLoginItemModel.item_type, masterLoginItemModel.item_count);
